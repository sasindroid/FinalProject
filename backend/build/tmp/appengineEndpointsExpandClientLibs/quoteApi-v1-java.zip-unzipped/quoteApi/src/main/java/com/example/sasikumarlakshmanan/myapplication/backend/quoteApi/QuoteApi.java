 ...
 * on 2016-04-24 at 22:18:11 UTC 
 * Modify at your own risk.
 */

package com.example.sasikumarlakshmanan.myapplication.backend.quoteApi;
...
public class QuoteApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetQuote extends QuoteApiRequest<com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(QuoteApi.this, "GET", REST_PATH, null, com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote.class);
   ...
   *
   * @param content the {@link com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteApiRequest<com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote content) {
      super(QuoteApi.this, "POST", REST_PATH, content, com.example.sasikumarlakshmanan.myapplication.backend.quoteApi.model.Quote.class);
    }
